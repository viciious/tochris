...
void D_SpriteScanRightEdge (void)
{
	...
	if (vvert < r_oldrefdef.fvrecty_adj)
		vvert = r_oldrefdef.fvrecty_adj;
	if (vvert > r_oldrefdef.fvrectbottom_adj)
		vvert = r_oldrefdef.fvrectbottom_adj;
	...
	do
	{
		...
		vnext = pnext->v;
		if (vnext < r_oldrefdef.fvrecty_adj)
			vnext = r_oldrefdef.fvrecty_adj;
		if (vnext > r_oldrefdef.fvrectbottom_adj)
			vnext = r_oldrefdef.fvrectbottom_adj;
		...
		{
			uvert = pvert->u;
			if (uvert < r_oldrefdef.fvrectx_adj)
				uvert = r_oldrefdef.fvrectx_adj;
			if (uvert > r_oldrefdef.fvrectright_adj)
				uvert = r_oldrefdef.fvrectright_adj;

			unext = pnext->u;
			if (unext < r_oldrefdef.fvrectx_adj)
				unext = r_oldrefdef.fvrectx_adj;
			if (unext > r_oldrefdef.fvrectright_adj)
				unext = r_oldrefdef.fvrectright_adj;
